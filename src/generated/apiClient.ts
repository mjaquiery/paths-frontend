...
import type {
  ...
  StartCreateEntryDraftParams,
  StartEditEntryDraftParams,
...
export type updatePathResponse = (updatePathResponseSuccess | updatePathResponseError)
...
export const updatePath = async (pathCode: string,
    pathUpdateRequest: PathUpdateRequest, options?: RequestInit): Promise<updatePathResponse> => {
...
export const getUpdatePathMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePath>>, TError,{pathCode: string;data: PathUpdateRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePath>>, TError,{pathCode: string;data: PathUpdateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePath>>, {pathCode: string;data: PathUpdateRequest}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePathMutationResult = NonNullable<Awaited<ReturnType<typeof updatePath>>>
 ...
 * @summary Update Path
 */
export const useUpdatePath = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePath>>, TError,{pathCode: string;data: PathUpdateRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
...
export const deletePath = async (pathCode: string, options?: RequestInit): Promise<deletePathResponse> => {
...
export const getDeletePathMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePath>>, TError,{pathCode: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deletePath>>, TError,{pathCode: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deletePath>>, {pathCode: string}> = (props) => {
 ...
 * @summary Delete Path
 */
export const useDeletePath = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePath>>, TError,{pathCode: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
...
/**
 * Get or create an open 'create' draft for the given path and day. Returns the existing open draft for this user/path/day if one exists, otherwise creates a new one.
 * @summary Start Create Entry Draft
 */
export type startCreateEntryDraftResponse200 = {
  data: EntryDraftResponse
  status: 200
}

export type startCreateEntryDraftResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type startCreateEntryDraftResponseSuccess = (startCreateEntryDraftResponse200) & {
  headers: Headers;
};
export type startCreateEntryDraftResponseError = (startCreateEntryDraftResponse422) & {
  headers: Headers;
};

export type startCreateEntryDraftResponse = (startCreateEntryDraftResponseSuccess | startCreateEntryDraftResponseError)

export const getStartCreateEntryDraftUrl = (pathCode: string,
    params: StartCreateEntryDraftParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/v1/paths/${pathCode}/entries/drafts?${stringifiedParams}` : `/v1/paths/${pathCode}/entries/drafts`
}

export const startCreateEntryDraft = async (pathCode: string,
    params: StartCreateEntryDraftParams, options?: RequestInit): Promise<startCreateEntryDraftResponse> => {
  
  return customFetch<startCreateEntryDraftResponse>(getStartCreateEntryDraftUrl(pathCode,params),
  {      
    ...options,
    method: 'GET'
...
export const getStartCreateEntryDraftQueryKey = (pathCode: MaybeRef<string>,
    params?: MaybeRef<StartCreateEntryDraftParams>,) => {
    return [
    'v1','paths',pathCode,'entries','drafts', ...(params ? [params] : [])
    ] as const;
    }

    
export const getStartCreateEntryDraftQueryOptions = <TData = Awaited<ReturnType<typeof startCreateEntryDraft>>, TError = HTTPValidationError>(pathCode: MaybeRef<string>,
    params: MaybeRef<StartCreateEntryDraftParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof startCreateEntryDraft>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  getStartCreateEntryDraftQueryKey(pathCode,params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof startCreateEntryDraft>>> = ({ signal }) => startCreateEntryDraft(unref(pathCode),unref(params), { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: computed(() => !!(unref(pathCode))), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof startCreateEntryDraft>>, TError, TData> 
}

export type StartCreateEntryDraftQueryResult = NonNullable<Awaited<ReturnType<typeof startCreateEntryDraft>>>
export type StartCreateEntryDraftQueryError = HTTPValidationError
...
export function useStartCreateEntryDraft<TData = Awaited<ReturnType<typeof startCreateEntryDraft>>, TError = HTTPValidationError>(
 pathCode: MaybeRef<string>,
    params: MaybeRef<StartCreateEntryDraftParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof startCreateEntryDraft>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient 
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {

  const queryOptions = getStartCreateEntryDraftQueryOptions(pathCode,params,options)
...
/**
 * Get or create an open 'edit' draft for the given entry. Returns the existing open draft for this user/entry if one exists, otherwise creates a new one.
 * @summary Start Edit Entry Draft
 */
export type startEditEntryDraftResponse200 = {
  data: EntryDraftResponse
  status: 200
}

export type startEditEntryDraftResponse409 = {
  data: OptimisticLockHTTPErrorResponse
  status: 409
}

export type startEditEntryDraftResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type startEditEntryDraftResponseSuccess = (startEditEntryDraftResponse200) & {
  headers: Headers;
};
export type startEditEntryDraftResponseError = (startEditEntryDraftResponse409 | startEditEntryDraftResponse422) & {
  headers: Headers;
};

export type startEditEntryDraftResponse = (startEditEntryDraftResponseSuccess | startEditEntryDraftResponseError)

export const getStartEditEntryDraftUrl = (pathCode: string,
    entrySlug: string,
    params: StartEditEntryDraftParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/v1/paths/${pathCode}/entries/${entrySlug}/draft?${stringifiedParams}` : `/v1/paths/${pathCode}/entries/${entrySlug}/draft`
}

export const startEditEntryDraft = async (pathCode: string,
    entrySlug: string,
    params: StartEditEntryDraftParams, options?: RequestInit): Promise<startEditEntryDraftResponse> => {
  
  return customFetch<startEditEntryDraftResponse>(getStartEditEntryDraftUrl(pathCode,entrySlug,params),
  {      
    ...options,
    method: 'GET'
...
export const getStartEditEntryDraftQueryKey = (pathCode: MaybeRef<string>,
    entrySlug: MaybeRef<string>,
    params?: MaybeRef<StartEditEntryDraftParams>,) => {
    return [
    'v1','paths',pathCode,'entries',entrySlug,'draft', ...(params ? [params] : [])
    ] as const;
    }

    
export const getStartEditEntryDraftQueryOptions = <TData = Awaited<ReturnType<typeof startEditEntryDraft>>, TError = OptimisticLockHTTPErrorResponse | HTTPValidationError>(pathCode: MaybeRef<string>,
    entrySlug: MaybeRef<string>,
    params: MaybeRef<StartEditEntryDraftParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof startEditEntryDraft>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  getStartEditEntryDraftQueryKey(pathCode,entrySlug,params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof startEditEntryDraft>>> = ({ signal }) => startEditEntryDraft(unref(pathCode),unref(entrySlug),unref(params), { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: computed(() => !!(unref(pathCode) && unref(entrySlug))), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof startEditEntryDraft>>, TError, TData> 
}

export type StartEditEntryDraftQueryResult = NonNullable<Awaited<ReturnType<typeof startEditEntryDraft>>>
export type StartEditEntryDraftQueryError = OptimisticLockHTTPErrorResponse | HTTPValidationError
...
export function useStartEditEntryDraft<TData = Awaited<ReturnType<typeof startEditEntryDraft>>, TError = OptimisticLockHTTPErrorResponse | HTTPValidationError>(
 pathCode: MaybeRef<string>,
    entrySlug: MaybeRef<string>,
    params: MaybeRef<StartEditEntryDraftParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof startEditEntryDraft>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient 
  ...
  const queryOptions = getStartEditEntryDraftQueryOptions(pathCode,entrySlug,params,options)
 ...
 */
export type getEntryDraftResponse200 = {
  data: EntryDraftResponse
  status: 200
}

export type getEntryDraftResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type getEntryDraftResponseSuccess = (getEntryDraftResponse200) & {
  headers: Headers;
};
export type getEntryDraftResponseError = (getEntryDraftResponse422) & {
  headers: Headers;
};

export type getEntryDraftResponse = (getEntryDraftResponseSuccess | getEntryDraftResponseError)

export const getGetEntryDraftUrl = (draftId: string,) => {
...
export const getEntryDraft = async (draftId: string, options?: RequestInit): Promise<getEntryDraftResponse> => {
  
  return customFetch<getEntryDraftResponse>(getGetEntryDraftUrl(draftId),
  {      
    ...options,
    method: 'GET'
...
export const getGetEntryDraftQueryKey = (draftId: MaybeRef<string>,) => {
    return [
    'v1','entry-drafts',draftId
    ] as const;
    }

    
export const getGetEntryDraftQueryOptions = <TData = Awaited<ReturnType<typeof getEntryDraft>>, TError = HTTPValidationError>(draftId: MaybeRef<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEntryDraft>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  getGetEntryDraftQueryKey(draftId);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getEntryDraft>>> = ({ signal }) => getEntryDraft(unref(draftId), { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: computed(() => !!(unref(draftId))), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getEntryDraft>>, TError, TData> 
}

export type GetEntryDraftQueryResult = NonNullable<Awaited<ReturnType<typeof getEntryDraft>>>
export type GetEntryDraftQueryError = HTTPValidationError
...
export function useGetEntryDraft<TData = Awaited<ReturnType<typeof getEntryDraft>>, TError = HTTPValidationError>(
 draftId: MaybeRef<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEntryDraft>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient 
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {

  const queryOptions = getGetEntryDraftQueryOptions(draftId,options)
 ...
 */
export type patchEntryDraftResponse200 = {
  data: EntryDraftResponse
  status: 200
}

export type patchEntryDraftResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type patchEntryDraftResponseSuccess = (patchEntryDraftResponse200) & {
  headers: Headers;
};
export type patchEntryDraftResponseError = (patchEntryDraftResponse422) & {
  headers: Headers;
};

export type patchEntryDraftResponse = (patchEntryDraftResponseSuccess | patchEntryDraftResponseError)

export const getPatchEntryDraftUrl = (draftId: string,) => {
...
export const patchEntryDraft = async (draftId: string,
    patchDraftRequest: PatchDraftRequest, options?: RequestInit): Promise<patchEntryDraftResponse> => {
  
  return customFetch<patchEntryDraftResponse>(getPatchEntryDraftUrl(draftId),
  {      
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getPatchEntryDraftMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchEntryDraft>>, TError,{draftId: string;data: PatchDraftRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof patchEntryDraft>>, TError,{draftId: string;data: PatchDraftRequest}, TContext> => {

const mutationKey = ['patchEntryDraft'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof patchEntryDraft>>, {draftId: string;data: PatchDraftRequest}> = (props) => {
          const {draftId,data} = props ?? {};

          return  patchEntryDraft(draftId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchEntryDraftMutationResult = NonNullable<Awaited<ReturnType<typeof patchEntryDraft>>>
    export type PatchEntryDraftMutationBody = PatchDraftRequest
    export type PatchEntryDraftMutationError = HTTPValidationError

    /**
 * @summary Patch Entry Draft
 */
export const usePatchEntryDraft = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchEntryDraft>>, TError,{draftId: string;data: PatchDraftRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof patchEntryDraft>>,
        TError,
        {draftId: string;data: PatchDraftRequest},
        TContext
      > => {
      return useMutation(getPatchEntryDraftMutationOptions(options), queryClient);
    }
    
/**
 * @summary Abandon Entry Draft
 */
export type abandonEntryDraftResponse204 = {
  data: void
  status: 204
}

export type abandonEntryDraftResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type abandonEntryDraftResponseSuccess = (abandonEntryDraftResponse204) & {
  headers: Headers;
};
export type abandonEntryDraftResponseError = (abandonEntryDraftResponse422) & {
  headers: Headers;
};

export type abandonEntryDraftResponse = (abandonEntryDraftResponseSuccess | abandonEntryDraftResponseError)

export const getAbandonEntryDraftUrl = (draftId: string,) => {
...
export const abandonEntryDraft = async (draftId: string, options?: RequestInit): Promise<abandonEntryDraftResponse> => {
  
  return customFetch<abandonEntryDraftResponse>(getAbandonEntryDraftUrl(draftId),
  {      
    ...options,
    method: 'DELETE'
...
export const getAbandonEntryDraftMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof abandonEntryDraft>>, TError,{draftId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof abandonEntryDraft>>, TError,{draftId: string}, TContext> => {

const mutationKey = ['abandonEntryDraft'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof abandonEntryDraft>>, {draftId: string}> = (props) => {
          const {draftId} = props ?? {};

          return  abandonEntryDraft(draftId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AbandonEntryDraftMutationResult = NonNullable<Awaited<ReturnType<typeof abandonEntryDraft>>>
    
    export type AbandonEntryDraftMutationError = HTTPValidationError

    /**
 * @summary Abandon Entry Draft
 */
export const useAbandonEntryDraft = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof abandonEntryDraft>>, TError,{draftId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof abandonEntryDraft>>,
        TError,
        {draftId: string},
        TContext
      > => {
      return useMutation(getAbandonEntryDraftMutationOptions(options), queryClient);
    }
    
/**
 * @summary Create Draft Image Slot
 */
export type createDraftImageSlotResponse201 = {
  data: DraftImageSlotResponse
  status: 201
}

export type createDraftImageSlotResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type createDraftImageSlotResponseSuccess = (createDraftImageSlotResponse201) & {
  headers: Headers;
};
export type createDraftImageSlotResponseError = (createDraftImageSlotResponse422) & {
  headers: Headers;
};

export type createDraftImageSlotResponse = (createDraftImageSlotResponseSuccess | createDraftImageSlotResponseError)

export const getCreateDraftImageSlotUrl = (draftId: string,) => {


  

  return `/v1/entry-drafts/${draftId}/images`
}

export const createDraftImageSlot = async (draftId: string,
    createDraftImageRequest: CreateDraftImageRequest, options?: RequestInit): Promise<createDraftImageSlotResponse> => {
  
  return customFetch<createDraftImageSlotResponse>(getCreateDraftImageSlotUrl(draftId),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateDraftImageSlotMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createDraftImageSlot>>, TError,{draftId: string;data: CreateDraftImageRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createDraftImageSlot>>, TError,{draftId: string;data: CreateDraftImageRequest}, TContext> => {

const mutationKey = ['createDraftImageSlot'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createDraftImageSlot>>, {draftId: string;data: CreateDraftImageRequest}> = (props) => {
          const {draftId,data} = props ?? {};

          return  createDraftImageSlot(draftId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateDraftImageSlotMutationResult = NonNullable<Awaited<ReturnType<typeof createDraftImageSlot>>>
    export type CreateDraftImageSlotMutationBody = CreateDraftImageRequest
    export type CreateDraftImageSlotMutationError = HTTPValidationError

    /**
 * @summary Create Draft Image Slot
 */
export const useCreateDraftImageSlot = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createDraftImageSlot>>, TError,{draftId: string;data: CreateDraftImageRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof createDraftImageSlot>>,
        TError,
        {draftId: string;data: CreateDraftImageRequest},
        TContext
      > => {
      return useMutation(getCreateDraftImageSlotMutationOptions(options), queryClient);
    }
    
/**
 * @summary Complete Draft Image Upload
 */
export type completeDraftImageUploadResponse200 = {
  data: DraftImageResponse
  status: 200
}

export type completeDraftImageUploadResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type completeDraftImageUploadResponseSuccess = (completeDraftImageUploadResponse200) & {
  headers: Headers;
};
export type completeDraftImageUploadResponseError = (completeDraftImageUploadResponse422) & {
  headers: Headers;
};

export type completeDraftImageUploadResponse = (completeDraftImageUploadResponseSuccess | completeDraftImageUploadResponseError)

export const getCompleteDraftImageUploadUrl = (draftId: string,
    draftImageId: string,) => {


  

  return `/v1/entry-drafts/${draftId}/images/${draftImageId}/complete`
}

export const completeDraftImageUpload = async (draftId: string,
    draftImageId: string,
    completeDraftImageRequest: CompleteDraftImageRequest, options?: RequestInit): Promise<completeDraftImageUploadResponse> => {
  
  return customFetch<completeDraftImageUploadResponse>(getCompleteDraftImageUploadUrl(draftId,draftImageId),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCompleteDraftImageUploadMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof completeDraftImageUpload>>, TError,{draftId: string;draftImageId: string;data: CompleteDraftImageRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof completeDraftImageUpload>>, TError,{draftId: string;draftImageId: string;data: CompleteDraftImageRequest}, TContext> => {

const mutationKey = ['completeDraftImageUpload'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof completeDraftImageUpload>>, {draftId: string;draftImageId: string;data: CompleteDraftImageRequest}> = (props) => {
          const {draftId,draftImageId,data} = props ?? {};

          return  completeDraftImageUpload(draftId,draftImageId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CompleteDraftImageUploadMutationResult = NonNullable<Awaited<ReturnType<typeof completeDraftImageUpload>>>
    export type CompleteDraftImageUploadMutationBody = CompleteDraftImageRequest
    export type CompleteDraftImageUploadMutationError = HTTPValidationError

    /**
 * @summary Complete Draft Image Upload
 */
export const useCompleteDraftImageUpload = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof completeDraftImageUpload>>, TError,{draftId: string;draftImageId: string;data: CompleteDraftImageRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof completeDraftImageUpload>>,
        TError,
        {draftId: string;draftImageId: string;data: CompleteDraftImageRequest},
        TContext
      > => {
      return useMutation(getCompleteDraftImageUploadMutationOptions(options), queryClient);
    }
    
/**
 * @summary Retry Draft Image Upload
 */
export type retryDraftImageUploadResponse200 = {
  data: DraftImageSlotResponse
  status: 200
}

export type retryDraftImageUploadResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type retryDraftImageUploadResponseSuccess = (retryDraftImageUploadResponse200) & {
  headers: Headers;
};
export type retryDraftImageUploadResponseError = (retryDraftImageUploadResponse422) & {
  headers: Headers;
};

export type retryDraftImageUploadResponse = (retryDraftImageUploadResponseSuccess | retryDraftImageUploadResponseError)

export const getRetryDraftImageUploadUrl = (draftId: string,
    draftImageId: string,) => {


  

  return `/v1/entry-drafts/${draftId}/images/${draftImageId}/retry-upload`
}

export const retryDraftImageUpload = async (draftId: string,
    draftImageId: string, options?: RequestInit): Promise<retryDraftImageUploadResponse> => {
  
  return customFetch<retryDraftImageUploadResponse>(getRetryDraftImageUploadUrl(draftId,draftImageId),
  {      
    ...options,
    method: 'POST'
...
export const getRetryDraftImageUploadMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof retryDraftImageUpload>>, TError,{draftId: string;draftImageId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof retryDraftImageUpload>>, TError,{draftId: string;draftImageId: string}, TContext> => {

const mutationKey = ['retryDraftImageUpload'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof retryDraftImageUpload>>, {draftId: string;draftImageId: string}> = (props) => {
          const {draftId,draftImageId} = props ?? {};

          return  retryDraftImageUpload(draftId,draftImageId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RetryDraftImageUploadMutationResult = NonNullable<Awaited<ReturnType<typeof retryDraftImageUpload>>>
    
    export type RetryDraftImageUploadMutationError = HTTPValidationError

    /**
 * @summary Retry Draft Image Upload
 */
export const useRetryDraftImageUpload = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof retryDraftImageUpload>>, TError,{draftId: string;draftImageId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof retryDraftImageUpload>>,
        TError,
        {draftId: string;draftImageId: string},
        TContext
      > => {
      return useMutation(getRetryDraftImageUploadMutationOptions(options), queryClient);
    }
    
/**
 * @summary Remove Draft Image
 */
export type removeDraftImageResponse200 = {
  data: DraftImageResponse
  status: 200
}

export type removeDraftImageResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type removeDraftImageResponseSuccess = (removeDraftImageResponse200) & {
  headers: Headers;
};
export type removeDraftImageResponseError = (removeDraftImageResponse422) & {
  headers: Headers;
};

export type removeDraftImageResponse = (removeDraftImageResponseSuccess | removeDraftImageResponseError)

export const getRemoveDraftImageUrl = (draftId: string,
    draftImageId: string,) => {


  

  return `/v1/entry-drafts/${draftId}/images/${draftImageId}`
}

export const removeDraftImage = async (draftId: string,
    draftImageId: string, options?: RequestInit): Promise<removeDraftImageResponse> => {
  
  return customFetch<removeDraftImageResponse>(getRemoveDraftImageUrl(draftId,draftImageId),
  {      
    ...options,
    method: 'DELETE'
...
export const getRemoveDraftImageMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof removeDraftImage>>, TError,{draftId: string;draftImageId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof removeDraftImage>>, TError,{draftId: string;draftImageId: string}, TContext> => {

const mutationKey = ['removeDraftImage'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof removeDraftImage>>, {draftId: string;draftImageId: string}> = (props) => {
          const {draftId,draftImageId} = props ?? {};

          return  removeDraftImage(draftId,draftImageId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RemoveDraftImageMutationResult = NonNullable<Awaited<ReturnType<typeof removeDraftImage>>>
    
    export type RemoveDraftImageMutationError = HTTPValidationError

    /**
 * @summary Remove Draft Image
 */
export const useRemoveDraftImage = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof removeDraftImage>>, TError,{draftId: string;draftImageId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof removeDraftImage>>,
        TError,
        {draftId: string;draftImageId: string},
        TContext
      > => {
      return useMutation(getRemoveDraftImageMutationOptions(options), queryClient);
    }
    
/**
 * @summary Commit Entry Draft
 */
export type commitEntryDraftResponse200 = {
  data: EntryContentResponse
  status: 200
}

export type commitEntryDraftResponse409 = {
  data: OptimisticLockHTTPErrorResponse
  status: 409
}

export type commitEntryDraftResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type commitEntryDraftResponseSuccess = (commitEntryDraftResponse200) & {
  headers: Headers;
};
export type commitEntryDraftResponseError = (commitEntryDraftResponse409 | commitEntryDraftResponse422) & {
  headers: Headers;
};

export type commitEntryDraftResponse = (commitEntryDraftResponseSuccess | commitEntryDraftResponseError)

export const getCommitEntryDraftUrl = (draftId: string,) => {


  

  return `/v1/entry-drafts/${draftId}/commit`
}

export const commitEntryDraft = async (draftId: string, options?: RequestInit): Promise<commitEntryDraftResponse> => {
  
  return customFetch<commitEntryDraftResponse>(getCommitEntryDraftUrl(draftId),
  {      
    ...options,
    method: 'POST'
...
export const getCommitEntryDraftMutationOptions = <TError = OptimisticLockHTTPErrorResponse | HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof commitEntryDraft>>, TError,{draftId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof commitEntryDraft>>, TError,{draftId: string}, TContext> => {

const mutationKey = ['commitEntryDraft'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof commitEntryDraft>>, {draftId: string}> = (props) => {
          const {draftId} = props ?? {};

          return  commitEntryDraft(draftId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CommitEntryDraftMutationResult = NonNullable<Awaited<ReturnType<typeof commitEntryDraft>>>
    
    export type CommitEntryDraftMutationError = OptimisticLockHTTPErrorResponse | HTTPValidationError

    /**
 * @summary Commit Entry Draft
 */
export const useCommitEntryDraft = <TError = OptimisticLockHTTPErrorResponse | HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof commitEntryDraft>>, TError,{draftId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        Awaited<ReturnType<typeof commitEntryDraft>>,
        TError,
        {draftId: string},
        TContext
      > => {
      return useMutation(getCommitEntryDraftMutationOptions(options), queryClient);
    }
...
export const updateSettings = async (userSettingsUpdateRequest: UserSettingsUpdateRequest, options?: RequestInit): Promise<updateSettingsResponse> => {
...
export const getUpdateSettingsMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateSettings>>, TError,{data: UserSettingsUpdateRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateSettings>>, TError,{data: UserSettingsUpdateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateSettings>>, {data: UserSettingsUpdateRequest}> = (props) => {
          const {data} = props ?? {};
...
export const getUpdatePathResponseMock = (overrideResponse: Partial<Extract<PathResponse, object>> = {}): PathResponse => ({path_id: faker.string.alpha({length: {min: 10, max: 20}}), uuid: faker.string.uuid(), owner_user_id: faker.string.uuid(), title: faker.string.alpha({length: {min: 10, max: 20}}), description: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), color: faker.string.alpha({length: {min: 10, max: 20}}), is_public: faker.datatype.boolean(), created_at: faker.date.past().toISOString().slice(0, 19) + 'Z', updated_at: faker.date.past().toISOString().slice(0, 19) + 'Z', ...overrideResponse})
...
export const getStartCreateEntryDraftResponseMock = (overrideResponse: Partial<Extract<EntryDraftResponse, object>> = {}): EntryDraftResponse => ({id: faker.string.uuid(), mode: faker.string.alpha({length: {min: 10, max: 20}}), state: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.uuid(), entry_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), day: faker.date.past().toISOString().slice(0, 10), content: faker.string.alpha({length: {min: 10, max: 20}}), based_on_edit_id: faker.helpers.arrayElement([faker.number.int(),null,]), images: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), live_image_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), byte_size: faker.helpers.arrayElement([faker.number.int(),null,]), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,])})), expires_at: faker.date.past().toISOString().slice(0, 19) + 'Z', ...overrideResponse})

export const getStartEditEntryDraftResponseMock = (overrideResponse: Partial<Extract<EntryDraftResponse, object>> = {}): EntryDraftResponse => ({id: faker.string.uuid(), mode: faker.string.alpha({length: {min: 10, max: 20}}), state: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.uuid(), entry_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), day: faker.date.past().toISOString().slice(0, 10), content: faker.string.alpha({length: {min: 10, max: 20}}), based_on_edit_id: faker.helpers.arrayElement([faker.number.int(),null,]), images: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), live_image_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), byte_size: faker.helpers.arrayElement([faker.number.int(),null,]), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,])})), expires_at: faker.date.past().toISOString().slice(0, 19) + 'Z', ...overrideResponse})

export const getGetEntryDraftResponseMock = (overrideResponse: Partial<Extract<EntryDraftResponse, object>> = {}): EntryDraftResponse => ({id: faker.string.uuid(), mode: faker.string.alpha({length: {min: 10, max: 20}}), state: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.uuid(), entry_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), day: faker.date.past().toISOString().slice(0, 10), content: faker.string.alpha({length: {min: 10, max: 20}}), based_on_edit_id: faker.helpers.arrayElement([faker.number.int(),null,]), images: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), live_image_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), byte_size: faker.helpers.arrayElement([faker.number.int(),null,]), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,])})), expires_at: faker.date.past().toISOString().slice(0, 19) + 'Z', ...overrideResponse})

export const getPatchEntryDraftResponseMock = (overrideResponse: Partial<Extract<EntryDraftResponse, object>> = {}): EntryDraftResponse => ({id: faker.string.uuid(), mode: faker.string.alpha({length: {min: 10, max: 20}}), state: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.uuid(), entry_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), day: faker.date.past().toISOString().slice(0, 10), content: faker.string.alpha({length: {min: 10, max: 20}}), based_on_edit_id: faker.helpers.arrayElement([faker.number.int(),null,]), images: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), live_image_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), byte_size: faker.helpers.arrayElement([faker.number.int(),null,]), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,])})), expires_at: faker.date.past().toISOString().slice(0, 19) + 'Z', ...overrideResponse})

export const getCreateDraftImageSlotResponseMock = (overrideResponse: Partial<Extract<DraftImageSlotResponse, object>> = {}): DraftImageSlotResponse => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), upload_url: faker.string.alpha({length: {min: 10, max: 20}}), expires_in_seconds: faker.number.int(), ...overrideResponse})

export const getCompleteDraftImageUploadResponseMock = (overrideResponse: Partial<Extract<DraftImageResponse, object>> = {}): DraftImageResponse => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), live_image_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), byte_size: faker.helpers.arrayElement([faker.number.int(),null,]), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), ...overrideResponse})

export const getRetryDraftImageUploadResponseMock = (overrideResponse: Partial<Extract<DraftImageSlotResponse, object>> = {}): DraftImageSlotResponse => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), upload_url: faker.string.alpha({length: {min: 10, max: 20}}), expires_in_seconds: faker.number.int(), ...overrideResponse})

export const getRemoveDraftImageResponseMock = (overrideResponse: Partial<Extract<DraftImageResponse, object>> = {}): DraftImageResponse => ({id: faker.string.uuid(), draft_id: faker.string.uuid(), source: faker.string.alpha({length: {min: 10, max: 20}}), live_image_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), filename: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.string.alpha({length: {min: 10, max: 20}}), content_type: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), strip_metadata: faker.datatype.boolean(), byte_size: faker.helpers.arrayElement([faker.number.int(),null,]), client_image_id: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), ...overrideResponse})

export const getCommitEntryDraftResponseMock = (overrideResponse: Partial<Extract<EntryContentResponse, object>> = {}): EntryContentResponse => ({id: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.alpha({length: {min: 10, max: 20}}), day: faker.date.past().toISOString().slice(0, 10), edit_id: faker.number.int(), content: faker.string.alpha({length: {min: 10, max: 20}}), image_filenames: faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), undefined]), ...overrideResponse})

export const getListEntriesResponseMock = (): EntryResponse[] => (Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.alpha({length: {min: 10, max: 20}}), day: faker.date.past().toISOString().slice(0, 10), edit_id: faker.number.int()})))

export const getCreateEntryResponseMock = (overrideResponse: Partial<Extract<EntryResponse, object>> = {}): EntryResponse => ({id: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.alpha({length: {min: 10, max: 20}}), day: faker.date.past().toISOString().slice(0, 10), edit_id: faker.number.int(), ...overrideResponse})

export const getGetEntryResponseMock = (overrideResponse: Partial<Extract<EntryContentResponse, object>> = {}): EntryContentResponse => ({id: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.alpha({length: {min: 10, max: 20}}), day: faker.date.past().toISOString().slice(0, 10), edit_id: faker.number.int(), content: faker.string.alpha({length: {min: 10, max: 20}}), image_filenames: faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), undefined]), ...overrideResponse})

export const getUpdateEntryResponseMock = (overrideResponse: Partial<Extract<EntryResponse, object>> = {}): EntryResponse => ({id: faker.string.alpha({length: {min: 10, max: 20}}), path_id: faker.string.alpha({length: {min: 10, max: 20}}), day: faker.date.past().toISOString().slice(0, 10), edit_id: faker.number.int(), ...overrideResponse})
...
export const getGetProfileResponseMock = (overrideResponse: Partial<Extract<UserProfileResponse, object>> = {}): UserProfileResponse => ({user_id: faker.string.uuid(), display_name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), settings_json: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), ...overrideResponse})

export const getUpdateDisplayNameResponseMock = (overrideResponse: Partial<Extract<UserProfileResponse, object>> = {}): UserProfileResponse => ({user_id: faker.string.uuid(), display_name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), settings_json: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), ...overrideResponse})

export const getUpdateSettingsResponseMock = (overrideResponse: Partial<Extract<UserProfileResponse, object>> = {}): UserProfileResponse => ({user_id: faker.string.uuid(), display_name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), settings_json: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), ...overrideResponse})
...
export const getListInvitationsResponseMock = (): InvitationResponse[] => (Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), path_id: faker.string.uuid(), path_code: faker.string.alpha({length: {min: 10, max: 20}}), path_title: faker.string.alpha({length: {min: 10, max: 20}}), inviter_user_id: faker.string.uuid(), inviter_email: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), invited_email: faker.string.alpha({length: {min: 10, max: 20}}), invited_user_id: faker.helpers.arrayElement([faker.string.uuid(),null,]), status: faker.string.alpha({length: {min: 10, max: 20}}), created_at: faker.date.past().toISOString().slice(0, 19) + 'Z', updated_at: faker.date.past().toISOString().slice(0, 19) + 'Z'})))
...
export const getUpdatePathMockHandler = (overrideResponse?: PathResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<PathResponse> | PathResponse), options?: RequestHandlerOptions) => {
  return http.patch('*/v1/paths/:pathCode', async (info: Parameters<Parameters<typeof http.patch>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getUpdatePathResponseMock(),
      { status: 200
      })
  }, options)
}

export const getDeletePathMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void), options?: RequestHandlerOptions) => {
  return http.delete('*/v1/paths/:pathCode', async (info: Parameters<Parameters<typeof http.delete>[1]>[0]) => {
...
export const getStartCreateEntryDraftMockHandler = (overrideResponse?: EntryDraftResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<EntryDraftResponse> | EntryDraftResponse), options?: RequestHandlerOptions) => {
  return http.get('*/v1/paths/:pathCode/entries/drafts', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getStartCreateEntryDraftResponseMock(),
      { status: 200
      })
  }, options)
}

export const getStartEditEntryDraftMockHandler = (overrideResponse?: EntryDraftResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<EntryDraftResponse> | EntryDraftResponse), options?: RequestHandlerOptions) => {
  return http.get('*/v1/paths/:pathCode/entries/:entrySlug/draft', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getStartEditEntryDraftResponseMock(),
      { status: 200
      })
  }, options)
}

export const getGetEntryDraftMockHandler = (overrideResponse?: EntryDraftResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<EntryDraftResponse> | EntryDraftResponse), options?: RequestHandlerOptions) => {
  return http.get('*/v1/entry-drafts/:draftId', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getGetEntryDraftResponseMock(),
      { status: 200
      })
  }, options)
}

export const getPatchEntryDraftMockHandler = (overrideResponse?: EntryDraftResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<EntryDraftResponse> | EntryDraftResponse), options?: RequestHandlerOptions) => {
  return http.patch('*/v1/entry-drafts/:draftId', async (info: Parameters<Parameters<typeof http.patch>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getPatchEntryDraftResponseMock(),
      { status: 200
      })
  }, options)
}

export const getAbandonEntryDraftMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void), options?: RequestHandlerOptions) => {
  return http.delete('*/v1/entry-drafts/:draftId', async (info: Parameters<Parameters<typeof http.delete>[1]>[0]) => {
  if (typeof overrideResponse === 'function') {await overrideResponse(info); }
...
export const getCreateDraftImageSlotMockHandler = (overrideResponse?: DraftImageSlotResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<DraftImageSlotResponse> | DraftImageSlotResponse), options?: RequestHandlerOptions) => {
  return http.post('*/v1/entry-drafts/:draftId/images', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getCreateDraftImageSlotResponseMock(),
      { status: 201
      })
  }, options)
}

export const getCompleteDraftImageUploadMockHandler = (overrideResponse?: DraftImageResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<DraftImageResponse> | DraftImageResponse), options?: RequestHandlerOptions) => {
  return http.post('*/v1/entry-drafts/:draftId/images/:draftImageId/complete', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getCompleteDraftImageUploadResponseMock(),
      { status: 200
      })
  }, options)
}

export const getRetryDraftImageUploadMockHandler = (overrideResponse?: DraftImageSlotResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<DraftImageSlotResponse> | DraftImageSlotResponse), options?: RequestHandlerOptions) => {
  return http.post('*/v1/entry-drafts/:draftId/images/:draftImageId/retry-upload', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getRetryDraftImageUploadResponseMock(),
      { status: 200
      })
  }, options)
}

export const getRemoveDraftImageMockHandler = (overrideResponse?: DraftImageResponse | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<DraftImageResponse> | DraftImageResponse), options?: RequestHandlerOptions) => {
  return http.delete('*/v1/entry-drafts/:draftId/images/:draftImageId', async (info: Parameters<Parameters<typeof http.delete>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getRemoveDraftImageResponseMock(),
      { status: 200
      })
  }, options)
}

export const getCommitEntryDraftMockHandler = (overrideResponse?: EntryContentResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<EntryContentResponse> | EntryContentResponse), options?: RequestHandlerOptions) => {
  return http.post('*/v1/entry-drafts/:draftId/commit', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getCommitEntryDraftResponseMock(),
      { status: 200
      })
  }, options)
}
...
export const getUpdateSettingsMockHandler = (overrideResponse?: UserProfileResponse | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<UserProfileResponse> | UserProfileResponse), options?: RequestHandlerOptions) => {
  return http.patch('*/v1/account/settings', async (info: Parameters<Parameters<typeof http.patch>[1]>[0]) => {
...
export const getPathsBackendAPIMock = () => [
  ...
  getUpdatePathMockHandler(),
  getDeletePathMockHandler(),
  getUpdatePathVisibilityMockHandler(),
  getStartCreateEntryDraftMockHandler(),
  getStartEditEntryDraftMockHandler(),
  getGetEntryDraftMockHandler(),
  getPatchEntryDraftMockHandler(),
  getAbandonEntryDraftMockHandler(),
  getCreateDraftImageSlotMockHandler(),
  getCompleteDraftImageUploadMockHandler(),
  getRetryDraftImageUploadMockHandler(),
  getRemoveDraftImageMockHandler(),
  getCommitEntryDraftMockHandler(),
