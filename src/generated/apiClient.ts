 ...
 * @summary List Paths
 */
export const listPaths = async ( options?: Parameters<typeof customFetch>[1]): Promise<listPathsResponse> => {
 ...
 * @summary Create Path
 */
export const createPath = async (pathCreateRequest: PathCreateRequest, options?: Parameters<typeof customFetch>[1]): Promise<createPathResponse> => {
...
export const updatePath = async (pathCode: string,
    pathUpdateRequest: PathUpdateRequest, options?: Parameters<typeof customFetch>[1]): Promise<updatePathResponse> => {
 ...
 * @summary Delete Path
 */
export const deletePath = async (pathCode: string, options?: Parameters<typeof customFetch>[1]): Promise<deletePathResponse> => {
...
export const updatePathVisibility = async (pathCode: string,
    pathVisibilityUpdateRequest: PathVisibilityUpdateRequest, options?: Parameters<typeof customFetch>[1]): Promise<updatePathVisibilityResponse> => {
 ...
 */
export const listEntries = async (pathCode: string, options?: Parameters<typeof customFetch>[1]): Promise<listEntriesResponse> => {
...
export const getListEntriesQueryOptions = <TData = Awaited<ReturnType<typeof listEntries>>, TError = HTTPValidationError>(pathCode: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listEntries>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getListEntriesQueryKey(pathCode);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listEntries>>> = ({ signal }) => listEntries(toValue(pathCode), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(pathCode) !== null && toValue(pathCode) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listEntries>>, TError, TData>
}
...
export function useListEntries<TData = Awaited<ReturnType<typeof listEntries>>, TError = HTTPValidationError>(
 pathCode: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listEntries>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
...
export const createEntry = async (pathCode: string,
    bodyCreateEntry: BodyCreateEntry, options?: Parameters<typeof customFetch>[1]): Promise<createEntryResponse> => {
...
if(bodyCreateEntry.captions !== undefined) {
 bodyCreateEntry.captions.forEach(value => formData.append(`captions`, value));
 }
...
export const getCreateEntryMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createEntry>>, TError,{pathCode: string;data: BodyCreateEntry}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createEntry>>, TError,{pathCode: string;data: BodyCreateEntry}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createEntry>>, {pathCode: string;data: BodyCreateEntry}> = (props) => {
          const {pathCode,data} = props ?? {};
...
export const getEntry = async (pathCode: string,
    entrySlug: string, options?: Parameters<typeof customFetch>[1]): Promise<getEntryResponse> => {
...
export const getGetEntryQueryKey = (pathCode: MaybeRefOrGetter<string>,
...
export const getGetEntryQueryOptions = <TData = Awaited<ReturnType<typeof getEntry>>, TError = HTTPValidationError>(pathCode: MaybeRefOrGetter<string>,
    entrySlug: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEntry>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getGetEntryQueryKey(pathCode,entrySlug);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getEntry>>> = ({ signal }) => getEntry(toValue(pathCode),toValue(entrySlug), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(pathCode) !== null && toValue(pathCode) !== undefined && toValue(entrySlug) !== null && toValue(entrySlug) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getEntry>>, TError, TData>
}
...
export const updateEntry = async (pathCode: string,
    entrySlug: string,
    bodyUpdateEntry: BodyUpdateEntry, options?: Parameters<typeof customFetch>[1]): Promise<updateEntryResponse> => {
    const formData = new FormData();
formData.append(`expected_edit_id`, bodyUpdateEntry.expected_edit_id.toString())
formData.append(`content`, bodyUpdateEntry.content);
if(bodyUpdateEntry.captions !== undefined) {
 bodyUpdateEntry.captions.forEach(value => formData.append(`captions`, value));
 }
if(bodyUpdateEntry.remove_image_ids !== undefined) {
 bodyUpdateEntry.remove_image_ids.forEach(value => formData.append(`remove_image_ids`, value));
 }
...
export const getUpdateEntryMutationOptions = <TError = OptimisticLockHTTPErrorResponse | HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateEntry>>, TError,{pathCode: string;entrySlug: string;data: BodyUpdateEntry}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateEntry>>, TError,{pathCode: string;entrySlug: string;data: BodyUpdateEntry}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateEntry>>, {pathCode: string;entrySlug: string;data: BodyUpdateEntry}> = (props) => {
...
export const deleteEntry = async (pathCode: string,
    entrySlug: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteEntryResponse> => {
...
export const listEntryImages = async (pathCode: string,
    entrySlug: string, options?: Parameters<typeof customFetch>[1]): Promise<listEntryImagesResponse> => {
...
export const getListEntryImagesQueryKey = (pathCode: MaybeRefOrGetter<string>,
    entrySlug: MaybeRefOrGetter<string>,) => {
    return [
...
export const getListEntryImagesQueryOptions = <TData = Awaited<ReturnType<typeof listEntryImages>>, TError = HTTPValidationError>(pathCode: MaybeRefOrGetter<string>,
    entrySlug: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listEntryImages>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getListEntryImagesQueryKey(pathCode,entrySlug);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listEntryImages>>> = ({ signal }) => listEntryImages(toValue(pathCode),toValue(entrySlug), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(pathCode) !== null && toValue(pathCode) !== undefined && toValue(entrySlug) !== null && toValue(entrySlug) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listEntryImages>>, TError, TData>
}
 ...
 */
export const listSubscriptions = async (pathCode: string, options?: Parameters<typeof customFetch>[1]): Promise<listSubscriptionsResponse> => {
...
export const getListSubscriptionsQueryKey = (pathCode: MaybeRefOrGetter<string>,) => {
    return [
...
export const getListSubscriptionsQueryOptions = <TData = Awaited<ReturnType<typeof listSubscriptions>>, TError = HTTPValidationError>(pathCode: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listSubscriptions>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getListSubscriptionsQueryKey(pathCode);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listSubscriptions>>> = ({ signal }) => listSubscriptions(toValue(pathCode), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(pathCode) !== null && toValue(pathCode) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSubscriptions>>, TError, TData>
}
...
export function useListSubscriptions<TData = Awaited<ReturnType<typeof listSubscriptions>>, TError = HTTPValidationError>(
 pathCode: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listSubscriptions>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
...
export const inviteSubscriber = async (pathCode: string,
    subscriptionInviteRequest: SubscriptionInviteRequest, options?: Parameters<typeof customFetch>[1]): Promise<inviteSubscriberResponse> => {
...
export const deleteSubscription = async (pathCode: string,
    targetUserId: string, options?: Parameters<typeof customFetch>[1]): Promise<deleteSubscriptionResponse> => {
...
export const setPathCreationApproval = async (userId: string,
    pathCreationApprovalRequest: PathCreationApprovalRequest, options?: Parameters<typeof customFetch>[1]): Promise<setPathCreationApprovalResponse> => {
 ...
 * @summary Get Profile
 */
export const getProfile = async ( options?: Parameters<typeof customFetch>[1]): Promise<getProfileResponse> => {
 ...
 */
export const updateDisplayName = async (userDisplayNameUpdateRequest: UserDisplayNameUpdateRequest, options?: Parameters<typeof customFetch>[1]): Promise<updateDisplayNameResponse> => {
 ...
 */
export const updateSettings = async (userSettingsUpdateRequest: UserSettingsUpdateRequest, options?: Parameters<typeof customFetch>[1]): Promise<updateSettingsResponse> => {
 ...
 */
export const createDeletionRequest = async ( options?: Parameters<typeof customFetch>[1]): Promise<createDeletionRequestResponse> => {
 ...
 */
export const getLatestDeletionRequest = async ( options?: Parameters<typeof customFetch>[1]): Promise<getLatestDeletionRequestResponse> => {
...
export type updateImageCaptionResponseSuccess = (updateImageCaptionResponse200) & {
  headers: Headers;
};
...
export type updateImageCaptionResponse = (updateImageCaptionResponseSuccess | updateImageCaptionResponseError)
 ...
 */
export const updateImageCaption = async (imageId: string,
    imageCaptionUpdateRequest: ImageCaptionUpdateRequest, options?: Parameters<typeof customFetch>[1]): Promise<updateImageCaptionResponse> => {

  return customFetch<updateImageCaptionResponse>(getUpdateImageCaptionUrl(imageId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateImageCaptionMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateImageCaption>>, TError,{imageId: string;data: ImageCaptionUpdateRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateImageCaption>>, TError,{imageId: string;data: ImageCaptionUpdateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateImageCaption>>, {imageId: string;data: ImageCaptionUpdateRequest}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateImageCaptionMutationResult = NonNullable<Awaited<ReturnType<typeof updateImageCaption>>>
 ...
 * @summary Update Image Caption
 */
export const useUpdateImageCaption = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateImageCaption>>, TError,{imageId: string;data: ImageCaptionUpdateRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationReturnType<
        ...
        TContext
      > => {
      return useMutation(getUpdateImageCaptionMutationOptions(options), queryClient);
    }
 ...
 */
export const getImageDownloadUrl = async (imageId: string, options?: Parameters<typeof customFetch>[1]): Promise<getImageDownloadUrlResponse> => {
...
export const getGetImageDownloadUrlQueryKey = (imageId: MaybeRefOrGetter<string>,) => {
    return [
...
export const getGetImageDownloadUrlQueryOptions = <TData = Awaited<ReturnType<typeof getImageDownloadUrl>>, TError = HTTPValidationError>(imageId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getImageDownloadUrl>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getGetImageDownloadUrlQueryKey(imageId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getImageDownloadUrl>>> = ({ signal }) => getImageDownloadUrl(toValue(imageId), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(imageId) !== null && toValue(imageId) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getImageDownloadUrl>>, TError, TData>
}
...
export function useGetImageDownloadUrl<TData = Awaited<ReturnType<typeof getImageDownloadUrl>>, TError = HTTPValidationError>(
 imageId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getImageDownloadUrl>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
 ...
 */
export const createExport = async (exportCreateRequest: ExportCreateRequest, options?: Parameters<typeof customFetch>[1]): Promise<createExportResponse> => {
 ...
 * @summary Get Export
 */
export const getExport = async (exportId: string, options?: Parameters<typeof customFetch>[1]): Promise<getExportResponse> => {
...
export const getGetExportQueryOptions = <TData = Awaited<ReturnType<typeof getExport>>, TError = HTTPValidationError>(exportId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getExport>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getGetExportQueryKey(exportId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getExport>>> = ({ signal }) => getExport(toValue(exportId), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(exportId) !== null && toValue(exportId) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getExport>>, TError, TData>
}
...
export function useGetExport<TData = Awaited<ReturnType<typeof getExport>>, TError = HTTPValidationError>(
 exportId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getExport>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
 ...
 */
export const downloadExportJson = async (exportId: string, options?: Parameters<typeof customFetch>[1]): Promise<downloadExportJsonResponse> => {
...
export const getDownloadExportJsonQueryKey = (exportId: MaybeRefOrGetter<string>,) => {
    return [
...
export const getDownloadExportJsonQueryOptions = <TData = Awaited<ReturnType<typeof downloadExportJson>>, TError = HTTPValidationError>(exportId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof downloadExportJson>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getDownloadExportJsonQueryKey(exportId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof downloadExportJson>>> = ({ signal }) => downloadExportJson(toValue(exportId), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(exportId) !== null && toValue(exportId) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof downloadExportJson>>, TError, TData>
}
...
export function useDownloadExportJson<TData = Awaited<ReturnType<typeof downloadExportJson>>, TError = HTTPValidationError>(
 exportId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof downloadExportJson>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
 ...
 */
export const downloadExportImages = async (exportId: string, options?: Parameters<typeof customFetch>[1]): Promise<downloadExportImagesResponse> => {
...
export const getDownloadExportImagesQueryKey = (exportId: MaybeRefOrGetter<string>,) => {
    return [
...
export const getDownloadExportImagesQueryOptions = <TData = Awaited<ReturnType<typeof downloadExportImages>>, TError = HTTPValidationError>(exportId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof downloadExportImages>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getDownloadExportImagesQueryKey(exportId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof downloadExportImages>>> = ({ signal }) => downloadExportImages(toValue(exportId), { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: computed(() => toValue(exportId) !== null && toValue(exportId) !== undefined), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof downloadExportImages>>, TError, TData>
}
...
export function useDownloadExportImages<TData = Awaited<ReturnType<typeof downloadExportImages>>, TError = HTTPValidationError>(
 exportId: MaybeRefOrGetter<string>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof downloadExportImages>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
 ...
 * @summary Oauth Login
 */
export const authLogin = async (params: AuthLoginParams, options?: Parameters<typeof customFetch>[1]): Promise<authLoginResponse> => {
...
export const getAuthLoginQueryKey = (params?: MaybeRefOrGetter<AuthLoginParams>,) => {
    return [
...
export const getAuthLoginQueryOptions = <TData = Awaited<ReturnType<typeof authLogin>>, TError = HTTPValidationError>(params: MaybeRefOrGetter<AuthLoginParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof authLogin>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getAuthLoginQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof authLogin>>> = ({ signal }) => authLogin(toValue(params), { signal, ...requestOptions });
...
export function useAuthLogin<TData = Awaited<ReturnType<typeof authLogin>>, TError = HTTPValidationError>(
 params: MaybeRefOrGetter<AuthLoginParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof authLogin>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
 ): UseQueryReturnType<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
 ...
 */
export const authCallback = async (oAuthCallbackRequest: OAuthCallbackRequest, options?: Parameters<typeof customFetch>[1]): Promise<authCallbackResponse> => {
 ...
 */
export const authCallbackRedirect = async (params: AuthCallbackRedirectParams, options?: Parameters<typeof customFetch>[1]): Promise<authCallbackRedirectResponse> => {
...
export const getAuthCallbackRedirectQueryKey = (params?: MaybeRefOrGetter<AuthCallbackRedirectParams>,) => {
    return [
...
export const getAuthCallbackRedirectQueryOptions = <TData = Awaited<ReturnType<typeof authCallbackRedirect>>, TError = HTTPValidationError>(params: MaybeRefOrGetter<AuthCallbackRedirectParams>, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof authCallbackRedirect>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  getAuthCallbackRedirectQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof authCallbackRedirect>>> = ({ signal }) => authCallbackRedirect(toValue(params), { signal, ...requestOptions });
 ...
 */
export const listInvitations = async ( options?: Parameters<typeof customFetch>[1]): Promise<listInvitationsResponse> => {
 ...
 */
export const acceptInvitation = async (invitationId: string, options?: Parameters<typeof customFetch>[1]): Promise<acceptInvitationResponse> => {
 ...
 */
export const ignoreInvitation = async (invitationId: string, options?: Parameters<typeof customFetch>[1]): Promise<ignoreInvitationResponse> => {
 ...
 */
export const listBlocklist = async ( options?: Parameters<typeof customFetch>[1]): Promise<listBlocklistResponse> => {
 ...
 */
export const blockInviter = async (blocklistAddRequest: BlocklistAddRequest, options?: Parameters<typeof customFetch>[1]): Promise<blockInviterResponse> => {
 ...
 */
export const unblockUser = async (blockedUserId: string, options?: Parameters<typeof customFetch>[1]): Promise<unblockUserResponse> => {
 ...
 * @summary Root
 */
export const root = async ( options?: Parameters<typeof customFetch>[1]): Promise<rootResponse> => {
