...
export const createEntry = async (pathCode: string,
    bodyCreateEntry: BodyCreateEntry, options?: RequestInit): Promise<createEntryResponse> => {
...
export const updateEntry = async (pathCode: string,
    entrySlug: string,
    bodyUpdateEntry: BodyUpdateEntry, options?: RequestInit): Promise<updateEntryResponse> => {
    const formData = new FormData();
...
export const updateImageCaption = async (imageId: string,
    imageCaptionUpdateRequest: ImageCaptionUpdateRequest, options?: RequestInit): Promise<updateImageCaptionResponse> => {
