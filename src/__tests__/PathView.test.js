...
var PathView_vue_1 = require("../views/PathView.vue");
vitest_1.vi.mock('vue-router', function () { return ({
    useRoute: function () { return ({ params: { pathId: 'p1' }, query: {} }); },
...
(0, vitest_1.describe)('PathView', function () {
    (0, vitest_1.it)('renders without crashing', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wrapper = (0, test_utils_1.mount)(PathView_vue_1.default, {
                global: {
    ...
    (0, vitest_1.it)('shows empty state when no entries', function () { return __awaiter(void 0, void 0, void 0, function () {
        var queryClient, wrapper;
        return __generator(this, function (_a) {
            queryClient = new vue_query_1.QueryClient({
                defaultOptions: { queries: { retry: false } },
            ...
            (0, vitest_1.expect)(wrapper.html()).toContain('No entries yet');
            return [2 /*return*/];
        });
    }); });
});
