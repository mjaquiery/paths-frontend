...
(0, vitest_1.describe)('DateView', function () {
    (0, vitest_1.it)('renders without crashing', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wrapper = (0, test_utils_1.mount)(DateView_vue_1.default, {
                global: {
    ...
    (0, vitest_1.it)('shows "No entries for this day" when there are no entries', function () { return __awaiter(void 0, void 0, void 0, function () {
        var queryClient, wrapper;
        return __generator(this, function (_a) {
            queryClient = new vue_query_1.QueryClient({
                defaultOptions: { queries: { retry: false } },
            ...
            (0, vitest_1.expect)(wrapper.html()).toContain('No entries for this day');
            return [2 /*return*/];
        });
    }); });
});
