...
(0, vitest_1.describe)('App bootstrap (Nuxt)', function () {
    (0, vitest_1.it)('loads nuxt config without throwing at module level', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, Promise.resolve().then(function () { return require('../../nuxt.config'); })];
                case 1:
                    // nuxt.config.ts is a pure-config file — importing it should never throw.
                    // (The actual mounting test is in the e2e/playwright suite.)
                    _a.sent();
