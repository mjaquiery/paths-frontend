...
var doDeletePath = (0, apiClient_1.useDeletePath)().mutateAsync;
var enqueue = (0, useApi_1.useApi)().enqueue;
var confirmation = (0, vue_2.ref)('');
var deleting = (0, vue_2.ref)(false);
...
function confirmDelete() {
    return __awaiter(this, void 0, void 0, function () {
        var pathCode, pathTitle;
        var _this = this;
        return __generator(this, function (_a) {
            if (confirmation.value !== props.path.title)
                return [2 /*return*/];
            deleting.value = true;
            pathCode = props.path.path_id;
            pathTitle = props.path.title;
            enqueue({
                id: "delete-path:".concat(pathCode),
                label: "Delete path \"".concat(pathTitle, "\""),
                execute: function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, doDeletePath({ pathCode: pathCode })];
                            case 1:
                                _a.sent();
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "delete-warning" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)(__assign({ class: "delete-warning-title" }));
...
var __VLS_46 = __VLS_asFunctionalComponent(__VLS_45, new __VLS_45({
    modelValue: (__VLS_ctx.confirmation),
    placeholder: (__VLS_ctx.path.title),
    autocomplete: "off",
}));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "delete-actions" }));
var __VLS_57 = {}.IonButton;
/** @type {[typeof __VLS_components.IonButton, typeof __VLS_components.ionButton, typeof __VLS_components.IonButton, typeof __VLS_components.ionButton, ]} */ ;
// @ts-ignore
var __VLS_58 = __VLS_asFunctionalComponent(__VLS_57, new __VLS_57(__assign({ 'onClick': {} }, { expand: "block", color: "danger", disabled: (__VLS_ctx.confirmation !== __VLS_ctx.path.title || __VLS_ctx.deleting) })));
var __VLS_59 = __VLS_58.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { expand: "block", color: "danger", disabled: (__VLS_ctx.confirmation !== __VLS_ctx.path.title || __VLS_ctx.deleting) })], __VLS_functionalComponentArgsRest(__VLS_58), false));
var __VLS_61;
var __VLS_62;
var __VLS_63;
var __VLS_64 = {
...
(__VLS_ctx.deleting ? 'Deleting…' : 'Delete Path');
var __VLS_60;
var __VLS_56;
var __VLS_52;
var __VLS_3;
...
/** @type {__VLS_StyleScopedClasses['delete-warning-title']} */ ;
