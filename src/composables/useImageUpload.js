...
function useImageUpload() {
    ...
    var requestUploadUrl = (0, apiClient_1.useCreateImageUploadUrl)().mutateAsync;
    var completeUpload = (0, apiClient_1.useCompleteImageUpload)().mutateAsync;
    function uploadImage(pathCode, entrySlug, file) {
        return __awaiter(this, void 0, void 0, function () {
            var urlResponse, uploadPayload, imageId, uploadUrl, putResponse, completeResponse, err_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, requestUploadUrl({
                                pathCode: pathCode,
                                entrySlug: entrySlug,
                                data: {
                                    filename: file.name,
                    ...
                    case 2:
                        urlResponse = _b.sent();
                        uploadPayload = urlResponse.status >= 200 && urlResponse.status < 300
                            ? urlResponse.data
                            : (function () {
                                throw new Error('Failed to get upload URL.');
                            })();
                        imageId = uploadPayload.image_id, uploadUrl = uploadPayload.upload_url;
    ...
    return { uploading: uploading, uploadError: uploadError, uploadImage: uploadImage };
}
